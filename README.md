...
```sh
  cd my-folder
  git clone https://github.com/alicemirigo92/blog_post
```
...
- GitHub: [Riyaz Ahmed](https://github.com/r-ahmed2022)
...
Feel free to check the [issues page](https://github.com/alicemirigo92/blog_post/issues).
...
If you like this project please leave a STAR to the [Github repo](https://github.com/alicemirigo92/blog_post/)
